    ...
    <div class="main_box">
      ...
      <div class="sidebar_menu">
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select * from complaint where smanid=?");
        ...
        %>
            <tr>
                ...
                <td><%= rs.getString("status") %></td>
                 <%-- <td><a href="t_17_AssignComplaintToSman.jsp?searchKey=<%=rs.getInt("searchKey") %>">Assign</a></td> --%>
            </tr>
        <% 
            }
        } catch (Exception e) {
